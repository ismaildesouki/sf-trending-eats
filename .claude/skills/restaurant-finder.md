...
2. **Search with intention** — lead with virality (TikTok/Instagram buzz), then curated sources (Infatuation/Eater), then narrow by constraints
3. **Present with personality** — for each rec: the buzz, what to order, the vibe, practical info, any caveats. Lead with top pick, offer 2-3 alternatives.
